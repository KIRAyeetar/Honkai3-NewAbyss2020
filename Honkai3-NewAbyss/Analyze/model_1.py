...
def run():
    ...
    原 苦痛保级人员占比20%, 平均每期水晶收益   260    337    331     328    327
    原 红莲升降人员占比10%, 平均每期水晶收益   340    416    404     397    394
    原 红莲保级人员占比4.5%, 平均每期水晶收益  420    474    470     465    462
    原 无限升降人员80人, 平均每期水晶收益      480    531    533     525    515
    原 无限保级人员10人, 平均每期水晶收益      600    600    605     570    549
    '''
    ...
    原罪人数占比 33%    50%     30%     33%    33%    32%
    苦痛人数占比 33%    33%     62%     60%    59     58%
    红莲人数占比 10%    ~~~     8 %     7 %    7 %    7 %
    '''
    for data_i in data_list:
    ...
    '''
       ...
       奖杯总数  141206425 239155484  232761202  230636073   229020192
    原罪奖杯总数  54675162  41713893   44959264   45054184    43054754
    苦痛奖杯总数  78911857  161497376  155260376  152999213   149846564
    红莲奖杯总数   175431   34952712   31004060   30984322    34059046
    '''
    ...
    '''
                 新1期   新24期   新48期   新72期    新96期
       平均凹度  0.700    0.721   0.732    0.748    0.760
    原罪平均凹度  0.691   0.514   0.489    0.465    0.455
    苦痛平均凹度  0.800   0.786   0.827    0.868    0.909
    红莲平均凹度  0.752   0.972   1.037    1.113    1.132
    '''
    ...
    原罪不打人数占比   15%     14%      16%     17%      17%
    苦痛不打人数占比   7 %     15%      13%     12%      11%
    红莲不打人数占比   ~~~    0.01%    0.01%   0.08%    0.09%
    '''
    for data_i in data_list:
        data_tmp = data_i
...
def graph(data, if_save=0, save_path=''):
    ...
    plt.savefig('../Data/graph/m1/原深渊等级人员水晶收益.jpg')
    # plt.show()
    ...
    data_graph = data_graph.set_index('abyss_count')
    data_graph.plot.line()
    plt.savefig('../Data/graph/m1/原深渊等级人员在新深渊等级变化.jpg')
    # plt.show()
    ...
    data_graph.plot.line()
    plt.xticks(np.arange(0, max(data['abyss_count'])+1, 4), np.arange(0, max(data['abyss_count'])+1, 4))
    plt.savefig('../Data/graph/m1/新深渊各等级人员数量变化.jpg')
    # plt.show()
